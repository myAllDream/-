package com.framework.app.pulltorefresh;
 ...
 */
public class RecycleviewRefreshView extends FrameLayout {
    ...
    public RecycleviewRefreshView(Context context) {
        super(context);
        initView();
    }

    public RecycleviewRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
        initView();
    }

    public RecycleviewRefreshView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.recycleview_freshView);
        try {
            mClipToPadding = a.getBoolean(R.styleable.recycleview_freshView_recyclerClipToPadding, false);
            mPadding = (int) a.getDimension(R.styleable.recycleview_freshView_recyclerPadding, -1.0f);
            mPaddingTop = (int) a.getDimension(R.styleable.recycleview_freshView_recyclerPaddingTop, 0.0f);
            mPaddingBottom = (int) a.getDimension(R.styleable.recycleview_freshView_recyclerPaddingBottom, 0.0f);
            mPaddingLeft = (int) a.getDimension(R.styleable.recycleview_freshView_recyclerPaddingLeft, 0.0f);
            mPaddingRight = (int) a.getDimension(R.styleable.recycleview_freshView_recyclerPaddingRight, 0.0f);
            mScrollbarStyle = a.getInteger(R.styleable.recycleview_freshView_scrollbarStyle, -1);
            mScrollbar = a.getInteger(R.styleable.recycleview_freshView_scrollbars, -1);
            mEmptyId = a.getResourceId(R.styleable.recycleview_freshView_layout_empty, 0);
            mProgressId = a.getResourceId(R.styleable.recycleview_freshView_layout_progress, 0);
            mErrorId = a.getResourceId(R.styleable.recycleview_freshView_layout_error, 0);
        } finally {
            a.recycle();
        }
    }
    ...
    private void initView() {
        ...
        mPtrLayout = v.findViewById(R.id.swipe_layout);
    ...
    protected void initRecyclerView(View view) {
        mRecycler = view.findViewById(R.id.custom_recyclerView);
