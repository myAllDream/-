...
abstract public class RecyclerArrayAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public RecyclerArrayAdapter(Context context,SwipeRefreshLayout mRefreshLayout) {
    ...
    private EventDelegateAble getEventDelegate() {
        if (mEventDelegate == null) {
            mEventDelegate = new DefaultEventDelegate(this,mRefreshLayout);
        }
    ...
    public void setMore(SwipeRefreshLayout swipeRefreshLayout,final int res, final OnMoreListener listener) {
