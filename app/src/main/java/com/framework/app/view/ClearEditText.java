...
public class ClearEditText extends EditText implements OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = getResources().getDrawable(R.mipmap.clear_edittext_cancel);
        }
    ...
    public void afterTextChanged(Editable s) {
        if (afterTextChangedListener != null) {
            if (s != null && !TextUtils.isEmpty(s.toString())) {
                afterTextChangedListener.afterTextChanged(this, s.toString(), true);
            } else {
                afterTextChangedListener.afterTextChanged(this, "", false);
            }
        }
    ...
    public interface AfterTextChangedListener {
        public void afterTextChanged(ClearEditText clearEditText, String s, boolean isChang);
    }
